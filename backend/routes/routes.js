...
import {loginUsuario, crearUsuario, VerUsuarios, actualizarEstadoUsuario, actualizarUsuario, obtenerUsuarioPorId, solicitarRecuperacionContrasena, verificarCodigoRecuperacion, restablecerContrasena, refreshAccessToken, logoutUsuario} from '../controllers/user.controller.js'
...
router.put('/usuarios/:id/estado', verificarRol(['superadmin', 'Super Administrador']), actualizarEstadoUsuario);
