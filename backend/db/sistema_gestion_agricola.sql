...
--
-- Dumping data for table `usuarios` (Original + 50 additional)
--
...
-- Additional 50 users
(4,'Cédula','1000000003','María González','3201234567','maria.gonzalez@agricola.com',SHA2('Maria123!', 256),'usuario','habilitado','2025-01-15 08:30:00'),
(5,'Cédula','1000000004','Carlos Rodríguez','3209876543','carlos.rodriguez@agricola.com',SHA2('Carlos123!', 256),'admin','habilitado','2025-01-16 09:15:00'),
(6,'Cédula','1000000005','Ana Martínez','3187654321','ana.martinez@agricola.com',SHA2('Ana123!', 256),'usuario','habilitado','2025-01-17 10:00:00'),
(7,'Cédula','1000000006','Luis Fernández','3156789012','luis.fernandez@agricola.com',SHA2('Luis123!', 256),'usuario','habilitado','2025-01-18 11:30:00'),
(8,'Cédula','1000000007','Carmen López','3145678901','carmen.lopez@agricola.com',SHA2('Carmen123!', 256),'admin','habilitado','2025-01-19 12:45:00'),
(9,'Cédula','1000000008','Roberto Silva','3134567890','roberto.silva@agricola.com',SHA2('Roberto123!', 256),'usuario','habilitado','2025-01-20 13:20:00'),
(10,'Cédula','1000000009','Patricia Morales','3123456789','patricia.morales@agricola.com',SHA2('Patricia123!', 256),'usuario','habilitado','2025-01-21 14:10:00'),
(11,'Cédula','1000000010','Diego Herrera','3112345678','diego.herrera@agricola.com',SHA2('Diego123!', 256),'admin','habilitado','2025-01-22 15:00:00'),
(12,'Cédula','1000000011','Sofía Jiménez','3101234567','sofia.jimenez@agricola.com',SHA2('Sofia123!', 256),'usuario','habilitado','2025-01-23 16:30:00'),
(13,'Cédula','1000000012','Andrés Vargas','3190123456','andres.vargas@agricola.com',SHA2('Andres123!', 256),'usuario','habilitado','2025-01-24 17:15:00'),
(14,'Cédula','1000000013','Valentina Castro','3189012345','valentina.castro@agricola.com',SHA2('Valentina123!', 256),'admin','habilitado','2025-01-25 08:45:00'),
(15,'Cédula','1000000014','Sebastián Ruiz','3178901234','sebastian.ruiz@agricola.com',SHA2('Sebastian123!', 256),'usuario','habilitado','2025-01-26 09:30:00'),
(16,'Cédula','1000000015','Isabella Torres','3167890123','isabella.torres@agricola.com',SHA2('Isabella123!', 256),'usuario','habilitado','2025-01-27 10:20:00'),
(17,'Cédula','1000000016','Mateo Ramírez','3156789012','mateo.ramirez@agricola.com',SHA2('Mateo123!', 256),'admin','habilitado','2025-01-28 11:10:00'),
(18,'Cédula','1000000017','Camila Flores','3145678901','camila.flores@agricola.com',SHA2('Camila123!', 256),'usuario','habilitado','2025-01-29 12:00:00'),
(19,'Cédula','1000000018','Santiago Mendoza','3134567890','santiago.mendoza@agricola.com',SHA2('Santiago123!', 256),'usuario','habilitado','2025-01-30 13:45:00'),
(20,'Cédula','1000000019','Lucía Peña','3123456789','lucia.pena@agricola.com',SHA2('Lucia123!', 256),'superadmin','habilitado','2025-02-01 14:30:00'),
(21,'Cédula','1000000020','Gabriel Ortiz','3112345678','gabriel.ortiz@agricola.com',SHA2('Gabriel123!', 256),'usuario','habilitado','2025-02-02 15:20:00'),
(22,'Cédula','1000000021','Mariana Guerrero','3101234567','mariana.guerrero@agricola.com',SHA2('Mariana123!', 256),'admin','habilitado','2025-02-03 16:10:00'),
(23,'Cédula','1000000022','Nicolás Vega','3190123456','nicolas.vega@agricola.com',SHA2('Nicolas123!', 256),'usuario','habilitado','2025-02-04 17:00:00'),
(24,'Cédula','1000000023','Alejandra Cruz','3189012345','alejandra.cruz@agricola.com',SHA2('Alejandra123!', 256),'usuario','habilitado','2025-02-05 08:15:00'),
(25,'Cédula','1000000024','Fernando Soto','3178901234','fernando.soto@agricola.com',SHA2('Fernando123!', 256),'admin','habilitado','2025-02-06 09:00:00'),
(26,'Cédula','1000000025','Daniela Ramos','3167890123','daniela.ramos@agricola.com',SHA2('Daniela123!', 256),'usuario','habilitado','2025-02-07 10:45:00'),
(27,'Cédula','1000000026','Emilio Aguilar','3156789012','emilio.aguilar@agricola.com',SHA2('Emilio123!', 256),'usuario','habilitado','2025-02-08 11:30:00'),
(28,'Cédula','1000000027','Natalia Delgado','3145678901','natalia.delgado@agricola.com',SHA2('Natalia123!', 256),'admin','habilitado','2025-02-09 12:15:00'),
(29,'Cédula','1000000028','Joaquín Molina','3134567890','joaquin.molina@agricola.com',SHA2('Joaquin123!', 256),'usuario','habilitado','2025-02-10 13:00:00'),
(30,'Cédula','1000000029','Valeria Campos','3123456789','valeria.campos@agricola.com',SHA2('Valeria123!', 256),'usuario','habilitado','2025-02-11 14:45:00'),
(31,'Cédula','1000000030','Maximiliano Reyes','3112345678','maximiliano.reyes@agricola.com',SHA2('Maximiliano123!', 256),'superadmin','habilitado','2025-02-12 15:30:00'),
(32,'Cédula','1000000031','Antonella Paredes','3101234567','antonella.paredes@agricola.com',SHA2('Antonella123!', 256),'usuario','habilitado','2025-02-13 16:20:00'),
(33,'Cédula','1000000032','Tomás Navarro','3190123456','tomas.navarro@agricola.com',SHA2('Tomas123!', 256),'admin','habilitado','2025-02-14 17:10:00'),
(34,'Cédula','1000000033','Regina Cortés','3189012345','regina.cortes@agricola.com',SHA2('Regina123!', 256),'usuario','habilitado','2025-02-15 08:00:00'),
(35,'Cédula','1000000034','Ignacio Sandoval','3178901234','ignacio.sandoval@agricola.com',SHA2('Ignacio123!', 256),'usuario','habilitado','2025-02-16 09:45:00'),
(36,'Cédula','1000000035','Renata Espinoza','3167890123','renata.espinoza@agricola.com',SHA2('Renata123!', 256),'admin','habilitado','2025-02-17 10:30:00'),
(37,'Cédula','1000000036','Benjamín Ibarra','3156789012','benjamin.ibarra@agricola.com',SHA2('Benjamin123!', 256),'usuario','habilitado','2025-02-18 11:15:00'),
(38,'Cédula','1000000037','Constanza Fuentes','3145678901','constanza.fuentes@agricola.com',SHA2('Constanza123!', 256),'usuario','habilitado','2025-02-19 12:00:00'),
(39,'Cédula','1000000038','Agustín Moreno','3134567890','agustin.moreno@agricola.com',SHA2('Agustin123!', 256),'admin','habilitado','2025-02-20 13:45:00'),
(40,'Cédula','1000000039','Florencia Rojas','3123456789','florencia.rojas@agricola.com',SHA2('Florencia123!', 256),'usuario','habilitado','2025-02-21 14:30:00'),
(41,'Cédula','1000000040','Vicente Carrasco','3112345678','vicente.carrasco@agricola.com',SHA2('Vicente123!', 256),'usuario','habilitado','2025-02-22 15:15:00'),
(42,'Cédula','1000000041','Esperanza Valdés','3101234567','esperanza.valdes@agricola.com',SHA2('Esperanza123!', 256),'superadmin','habilitado','2025-02-23 16:00:00'),
(43,'Cédula','1000000042','Rodrigo Palacios','3190123456','rodrigo.palacios@agricola.com',SHA2('Rodrigo123!', 256),'usuario','habilitado','2025-02-24 17:45:00'),
(44,'Cédula','1000000043','Amparo Figueroa','3189012345','amparo.figueroa@agricola.com',SHA2('Amparo123!', 256),'admin','habilitado','2025-02-25 08:30:00'),
(45,'Cédula','1000000044','Esteban Contreras','3178901234','esteban.contreras@agricola.com',SHA2('Esteban123!', 256),'usuario','habilitado','2025-02-26 09:15:00'),
(46,'Cédula','1000000045','Pilar Cáceres','3167890123','pilar.caceres@agricola.com',SHA2('Pilar123!', 256),'usuario','habilitado','2025-02-27 10:00:00'),
(47,'Cédula','1000000046','Cristóbal Muñoz','3156789012','cristobal.munoz@agricola.com',SHA2('Cristobal123!', 256),'admin','habilitado','2025-02-28 11:45:00'),
(48,'Cédula','1000000047','Magdalena Bravo','3145678901','magdalena.bravo@agricola.com',SHA2('Magdalena123!', 256),'usuario','habilitado','2025-03-01 12:30:00'),
(49,'Cédula','1000000048','Patricio Lara','3134567890','patricio.lara@agricola.com',SHA2('Patricio123!', 256),'usuario','habilitado','2025-03-02 13:15:00'),
(50,'Cédula','1000000049','Esperanza Vera','3123456789','esperanza.vera@agricola.com',SHA2('Esperanza123!', 256),'admin','habilitado','2025-03-03 14:00:00'),
(51,'Cédula','1000000050','Álvaro Medina','3112345678','alvaro.medina@agricola.com',SHA2('Alvaro123!', 256),'usuario','habilitado','2025-03-04 15:45:00'),
(52,'Cédula','1000000051','Beatriz Salinas','3101234567','beatriz.salinas@agricola.com',SHA2('Beatriz123!', 256),'usuario','habilitado','2025-03-05 16:30:00'),
(53,'Cédula','1000000052','Claudio Henríquez','3190123456','claudio.henriquez@agricola.com',SHA2('Claudio123!', 256),'superadmin','habilitado','2025-03-06 17:15:00');
